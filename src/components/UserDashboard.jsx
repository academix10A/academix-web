...
import { BookOpen, Star, Award, FileText, BarChart3, ChevronRight, TrendingUp, Clock, Target, Zap } from 'lucide-react'
      ...
      <div className={styles.inner}>
        ...
        <header className={styles.hero}>
          ...
          <div className={styles.heroContent}>
            ...
            <h1 className={styles.heroTitle}>{greeting}, {displayName}!</h1>
            <p className={styles.heroSub}>
              Aquí tienes un resumen de tu actividad en Academix.
              {membresia !== 'Básica' && (
                <span className={styles.membresiaBadge}>{membresia}</span>
              )}
            </p>
          </div>
        </header>
        ...
        <div className={styles.statsRow}>
          ...
          <div className={styles.statCard}>
            <div className={styles.statIcon} data-color="purple"><Target size={20} /></div>
            <div>
              <span className={styles.statNumber}>3</span>
              <span className={styles.statLabel}>Racha de días</span>
            </div>
          </div>
        </div>
